...
export const SecurityCard = ({ onPress }: SecurityCardProps) => {
    return (
        <TouchableOpacity
            onPress={onPress}
            className="mx-4 mb-6 bg-background dark:bg-darkBackgroundMuted rounded-2xl p-4 border border-neutral-200 dark:border-darkBorder"
        >
            <View className="flex-row items-center">
                ...
                <Text className="flex-1 ml-3 text-base font-poppins-semibold">
                    Security
                </Text>
