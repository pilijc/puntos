      ...
      <View style={{ width: "100%", minWidth }} className="w-full">
        <View
          className={
            variant === "divider"
              ? ""
              : "border border-slate-200 dark:border-neutral-600 rounded-xl overflow-hidden"
          }
        >
          <View
            className={
              variant === "divider"
                ? "flex-row border-b border-slate-200 dark:border-neutral-600"
                : "flex-row border-b border-slate-200 dark:border-neutral-600"
            }
          >
            {columns.map((col) => (
          ...
          {rows.length === 0 ? (
            ...
            rows.map((row, idx) => {
              ...
              const rowDivider =
                isLast ? "" : "border-b border-slate-200 dark:border-neutral-600";
              return (
                    ...
                    <View
                      className={
                        variant !== "divider" && !hideExpandedTopBorder
                          ? "border-t border-slate-200 dark:border-neutral-600 font-poppins"
                          : ""
                      }
                    >
