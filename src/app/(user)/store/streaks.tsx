          ...
          {streaks.map((streak) => {
            ...
            return (
              <TouchableOpacity
                ...
                className="bg-white dark:bg-darkBackgroundMuted rounded-3xl p-4 border border-neutral-100 dark:border-darkBorder"
              >
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center gap-x-3">
                    <View className="w-11 h-11 rounded-2xl bg-neutral-100 dark:bg-darkBackgroundCard items-center justify-center">
                ...
                <View className="h-2 bg-neutral-100 dark:bg-darkBackgroundCard rounded-full mt-3 overflow-hidden w-full">
                  <RNView
                    style={{
                      height: 8,
                      width: `${safeProgress}%`,
